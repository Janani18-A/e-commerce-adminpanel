    ...
    <div class="content-area">
        <div class="settings-container">
            <div class="settings-header" style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <h1 style="font-size: 22px; font-weight: 700; color: #1E293B;">✏️ Edit Delivery Method</h1>
                    <p style="font-size: 14px; color: #64748B; margin-top: 4px;">Update delivery method details.</p>
                </div>
