 ...
 <?php include 'templates/head.php'; ?>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        /* ===== VARIATION GRID - Two rows: Color|Size, Weight|Price|MRP ===== */
        .variations-grid {
            display: grid;
        ...
        /* Scrollable variation container - horizontal scroll */
        #variationsContainer {
            max-height: 450px;
            overflow-y: auto;
            overflow-x: auto;
    ...
    <div class="content-area main-content">
        <div id="add-product-page" class="page-section active-page">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <a href="product_v1.php" class="btn btn-outline-secondary btn-sm">
                ...
                <form id="addProductForm" onsubmit="return saveProduct(event)">
                    ...
                    <div id="variationsContainer">
                        <div class="variations-grid">
                            ...
                            <!-- ROW 1: EMPTY SPACE (for alignment) -->
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script>
        ...
        function saveProduct(e) {
            ...
            // ============================================================
            // Get Variations - Color, Size, Weight, Weight Unit, Price, MRP
            // ============================================================
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Add Product page initialized with two-row variation layout');
        });
    </script>
</body>
</html>