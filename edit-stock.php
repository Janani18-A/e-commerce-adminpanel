    ...
    <div class="content-area main-content">
        <div id="edit-stock-page" class="page-section active-page">
            ...
            <div class="form-section">
                <form id="editStockForm" onsubmit="return updateStockItem(event)">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script>
        ...
        function loadStockItem() {
            ...
            document.getElementById('itemStatus').value = item.status || 'In Stock';
            document.getElementById('itemSupplier').value = item.supplier || '';
            document.getElementById('itemLocation').value = item.location || '';
            document.getElementById('itemDescription').value = item.description || '';

            console.log('Stock item loaded:', item);
        }
        ...
        function updateStockItem(e) {
            ...
            if (index === -1) {
                showAlert('Stock item not found', 'error');
                return false;
            }
            ...
            showAlert(`Stock item '${item_name}' updated successfully!`, 'success');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Edit Stock page initialized (100% JavaScript with localStorage)');
        });
    </script>
</body>
</html>